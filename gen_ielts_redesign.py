...
def css(mc, mc_dark, mc_light):
    ...
    *,*::before,*::after{{box-sizing:border-box;}}
    ...
    .card h2{{font-family:'Poppins',sans-serif;font-weight:700;color:#0f172a;font-size:1.25rem;margin:0 0 1rem;padding-bottom:.6rem;border-bottom:2px solid {mc};display:block;}}
    .card h3{{font-family:'Poppins',sans-serif;font-weight:600;color:#1e293b;font-size:1rem;margin:1.1rem 0 .45rem;}}
    .card h4{{font-weight:600;color:#334155;font-size:.92rem;margin:.85rem 0 .35rem;}}
    .card p,.section-lead{{color:#475569;line-height:1.75;margin-bottom:.8rem;}}
    .card a{{color:{mc};text-decoration:none;font-weight:500;}}
    .card a:hover{{text-decoration:underline;}}
    /* ── RESOURCE LIST ── */
    .resource-list{{list-style:none;padding:0;margin:.4rem 0 .8rem;}}
    .resource-list li{{padding:.28rem 0 .28rem 1.2rem;position:relative;color:#475569;line-height:1.65;}}
    ...
    @media(prefers-color-scheme:dark){{
      ...
      .card p,.resource-list li,.card strong{{color:#94a3b8;}}
