...
(function () {
  ...
  COURSES_DB[CID] = {
    ...
    shortDesc: 'A practical 8-module career course for public-health graduates in Liberia and West Africa: core skills employers want, a standout CV and portfolio, the job search across NGOs, government and UN agencies, winning interviews, on-the-job skills (M&E, proposals, data), professional communication, and career advancement — with a final project and Certificate of Completion.',
    ...
    instructorBio: 'Samuel Tolbert founded TIH to help young Liberians and West Africans build careers that change their communities. This course brings practical, employer-focused career preparation to public-health graduates.',
    rating: 4.9,
    reviewCount: 0,
    ...
    learn: [
      'Map public-health career pathways and the West African job market',
      'Show the core skills employers want: epidemiology, data, M&E and more',
      'Write a standout public-health CV, cover letter and portfolio',
      'Find and win jobs with NGOs, the Ministry of Health and UN agencies',
    ...
    about: [
      'This is a practical career course built for public-health graduates in Liberia and West Africa who want to turn their degree into a real, growing career.',
