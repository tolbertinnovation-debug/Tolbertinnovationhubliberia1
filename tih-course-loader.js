...
(function () {
  ...
  var CURRICULUM = {
    ...
    "human-rights-ihl": "human-rights-ihl-curriculum.js",
  ...
  var EXTRAS = {
    ...
    'wassce-literature': ['wassce-literature-video-map.js?v=10', 'wassce-literature-quizzes.js?v=1', 'wassce-literature-notes.js?v=12'],
    ...
    'national-security-fundamentals': ['national-security-fundamentals-video-map.js?v=1', 'national-security-fundamentals-notes.js?v=1'],
